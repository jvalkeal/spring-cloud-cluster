...
/**
 * {@link LockService} implementation bases on Redis.
 * 
 * <p>This implementation delegates to {@link RedisLockRegistry}
 * found from Spring Integration.
 * 
...
public class RedisLockService implements LockService {
	...
	public RedisLockService(RedisConnectionFactory connectionFactory) {
		this.redisLockRegistry = new RedisLockRegistry(connectionFactory, "spring-cloud");
		Assert.notNull(connectionFactory, "Connection factory must be set");
	}
